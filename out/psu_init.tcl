...
set psu_mio_init_data {
    ...
    # UART receiver serial input) 7= Not Used
		# PSU_IOU_SLCR_MIO_PIN_74_L3_SEL                                                  6

		# Configures MIO Pin 74 peripheral interface mapping
		#(OFFSET, MASK, VALUE)      (0XFF180128, 0x000000FEU ,0x000000C0U)  */
    mask_write 0XFF180128 0x000000FE 0x000000C0
    ...
    # xd- (UART transmitter serial output) 7= Not Used
		# PSU_IOU_SLCR_MIO_PIN_75_L3_SEL                                                  6

		# Configures MIO Pin 75 peripheral interface mapping
		#(OFFSET, MASK, VALUE)      (0XFF18012C, 0x000000FEU ,0x000000C0U)  */
    mask_write 0XFF18012C 0x000000FE 0x000000C0
    ...
    mask_write 0XFF180134 0x000000FE 0x00000080
		...
		#(OFFSET, MASK, VALUE)      (0XFF180204, 0xFCFFFFFFU ,0x00000000U)  */
    mask_write 0XFF180204 0xFCFFFFFF 0x00000000
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x0003F000
		...
		#(OFFSET, MASK, VALUE)      (0XFF18020C, 0x00003FFFU ,0x00000600U)  */
    mask_write 0XFF18020C 0x00003FFF 0x00000600
    ...
    mask_write 0XFF180154 0x03FFFFFF 0x03FFFFFF
		...
		#(OFFSET, MASK, VALUE)      (0XFF180158, 0x03FFFFFFU ,0x03FC0FFFU)  */
    mask_write 0XFF180158 0x03FFFFFF 0x03FC0FFF
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x00000000
		...
		# Each bit applies to a single IO. Bit 0 for MIO[26].
		# PSU_IOU_SLCR_BANK1_CTRL4_PULL_HIGH_LOW_N_BIT_12                                 0
    ...
    #  MIO Bank 1 - control MIO[51:26]
		#(OFFSET, MASK, VALUE)      (0XFF180160, 0x03FFFFFFU ,0x03FFEFFFU)  */
    mask_write 0XFF180160 0x03FFFFFF 0x03FFEFFF
